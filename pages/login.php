...
<main class="auth-page">
    ...
    <div class="auth-container">
        <nav class="auth-breadcrumb" aria-label="<?= __('auth.breadcrumbLabel') ?>">
            <a href="../index.php"><?= __('navbar.home') ?></a><i class="fa-solid fa-chevron-right"></i><span><?= __('auth.loginTitle') ?></span>
        </nav>
        <section class="auth-card" aria-labelledby="login-title">
            ...
            <form class="auth-form" id="login-form" method="POST">
                <div class="form-group">
                    ...
                    <div class="input-wrapper"><i class="fa-regular fa-envelope"></i><input type="email" id="email" name="email" autocomplete="email" required></div>
                </div>
                <div class="form-group">
                    <label for="password"><?= __('auth.password') ?></label>
                    <div class="input-wrapper password-wrapper"><i class="fa-solid fa-lock"></i><input type="password" id="password" name="password" autocomplete="current-password" required><button type="button" class="password-toggle" aria-label="<?= __('auth.showPassword') ?>"><i class="fa-regular fa-eye"></i></button></div>
                </div>
                <div class="auth-options">
                    <label class="checkbox-label"><input type="checkbox" id="remember"><span><?= __('auth.rememberMe') ?></span></label>
                    <a href="../pages/contact.php"><?= __('auth.forgotPassword') ?></a>
                </div>
                <button class="auth-submit" type="submit"><?= __('auth.loginButton') ?></button>
            </form>
            <div class="auth-switch"><span><?= __('auth.noAccount') ?></span><a href="register.php"><?= __('auth.createAccount') ?></a></div>
        </section>
    </div>
</main>
